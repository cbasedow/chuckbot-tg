...
const tokenStandardSchema = z.enum([
...
const nativeTransferSchema = z.object({
	...
	toUserAccount: solanaBase58AddressSchema.or(z.literal("")).nullable(),
...
const tokenTransferSchema = z.object({
	...
	toTokenAccount: solanaBase58AddressSchema.or(z.literal("")).nullable(),
	tokenAmount: z.number().min(0),
	decimals: z.number().min(0).nullish(),
	tokenStandard: tokenStandardSchema.or(z.string()),
...
export const enhancedTxnSchema = z.object({
	...
	type: txnTypeSchema.or(z.string()),
	source: txnSourceSchema.or(z.string()),
	fee: z.number().min(0),
