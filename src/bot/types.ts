...
import type { Conversation, ConversationFlavor, ConversationMenu } from "@grammyjs/conversations";
...
export type MyConversationMenu = ConversationMenu<MyConversationContext>;
