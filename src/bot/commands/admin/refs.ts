...
import { onlyGroupAdmin } from "$/bot/middleware/only-group-admin";
...
export const refsCommand = new Command<MyContext>("refs", "View and manage group ref links", [
	onlyGroupAdmin("Only group admins can view and manage group ref links"),
	async (ctx) => {
